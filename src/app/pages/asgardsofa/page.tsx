    ...
    <div>   
        <div>
            ...
            <div className='flex space-x-5 py-5'>
                ...
                <Sheet>
  <SheetTrigger className="py-2 px-8 border-2 border-black rounded text-black">Add To Cart</SheetTrigger>
  <SheetContent>
    <SheetHeader>
      <SheetTitle className="text-[24px] text-black pb-4 border-b-2">Shopping Cart</SheetTitle>
      <SheetDescription>
...
<div className="flex flex-col sm:flex-row gap-4 py-8 justify-evenly">
  ...
  <p className="text-[16px] text-[#B88E24]">Rs. 250,000.00</p>
</div>


<div className="flex flex-col sm:flex-row gap-4 py-8 justify-evenly">
  <Link href='../pages/cart'><p className="text-[12px] text-black border-2 border-black w-28 rounded-2xl py-1 px-3 text-center">View Cart</p></Link>
  <Link href='../pages/checkout'><p className="text-[12px] text-black border-2 border-black w-28 rounded-2xl py-1 px-3 text-center">Checkout</p></Link>
...
<h1 className='text-[36px] font-medium text-black'>Related Products</h1>
...
<button className='text-[20px] border-b-2 border-black font-medium text-black'>Shop Now</button>
</div>
</section>
