        ...
        <section className=" max-w-5xl mx-auto flex flex-wrap justify-evenly gap-5 py-5">
          <div className=" w-[68%] px-5 ">
            ...
            <div className="flex flex-col md:flex-row items-center justify-evenly gap-5 md:gap-0 pt-3">
              ...
              <p className="h-8 w-8 text-[16px] border-2 border-[#9F9F9F] rounded text-center content-center">
                1
              </p>
              <p className="text-[16px] text-black">Rs. 250,000.00</p>
              <p className="text-[#FBEBB5]">
                <IoBag className="h-[21.88px] w-[21px]" />
              </p>
            </div>
          </div>
            ...
            <div className="flex flex-col space-y-5">
              ...
              <div className="text-center">
                <Link href="../pages/checkout">
                  {" "}
                  <button className="text-[20px] border-2 border-black py-1 px-4 text-black">
                    Check Out
                  </button>
                </Link>
              </div>
