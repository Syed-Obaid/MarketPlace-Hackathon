    ...
    <>
      <section className="max-w-screen-2xl mx-auto px-4 sm:px-6 md:px-8 py-10 pb-10 bg-[#FFFFFF]">
        <div className="text-center">
          ...
          <p className="text-[16px] text-[#9F9F9F] max-w-xl mx-auto">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 justify-center mx-auto gap-5 md:gap-0 py-8">
          <div className="flex flex-col items-center gap-5 justify-center">
            <div className="flex space-x-4">
              <span className="text-[24px] font-medium pt-2 text-black">
                <FaLocationDot />
              </span>
              <span>
                <h1 className="text-[24px] font-medium text-black">Address </h1>
                <p className="text-[16px] max-w-[12rem] text-black">
            ...
            <div className="flex space-x-4">
              ...
              <span>
                <h1 className="text-[24px] font-medium text-black">Phone </h1>
                <p className="text-[16px] max-w-[12rem] text-black">
                  Mobile: +(84) 546-6789
                </p>
                <p className="text-[16px] max-w-[12rem] text-black">
            ...
            <div className="flex flex-col items-center gap-7">
              <div>
                ...
                <input
                  ...
                  name=""
                  id=""
                  className="py-2 ps-2 border-2 w-[18rem] rounded"
                />
              </div>
              <div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  id=""
                  className="p-2 border-2 w-[18rem] rounded"
                ></textarea>
              </div>
              <div className="">
                <button className="text-[16px] py-2 border-2 px-12 rounded text-black">
                  Submit
                </button>
              </div>
            </div>
